...
# Functions called by Test Definitions in CiviTest-Tests-Vx.rb
...
#########################################################################
# Used in all or many business processes
...
def changeEndDate (offset: 365, status: 'New')
